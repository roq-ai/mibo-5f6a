...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create.create': {
    roles: ['owner', 'administrator', 'team-member', 'client-manager'],
    key: 'task',
    tenantPath: [],
    userPath: [],
  },
  ...
  'invoice.paid.update': {
    roles: ['owner', 'administrator', 'client-manager'],
    key: 'invoice',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'administrator', 'team-member', 'client-manager', 'end-customer'];
